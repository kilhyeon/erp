...
//		System.out.println(empDetail);
		...
		/*
		 * JFrame subFrame = new JFrame("사원 세부 정보"); subFrame.setVisible(true);
		 ...
		 * 
		 * subFrame.add(subDetailPanel, BorderLayout.CENTER); throw new
		 * UnsupportedOperationException("제공되지 않음");
		 */
	}
